...
function Update-Profile {
    ...
    try {
        $url = "https://github.com/Yanai-Klugman/dotfiles/tree/main/powershell/Microsoft.PowerShell_profile.ps1"
...
## Final Line to set prompt with Catppuccin Mocha theme
